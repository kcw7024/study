...
from tensorflow.python.keras.layers import Dense, Activation, Input, Dropout, Conv2D, Flatten, LSTM, Conv1D
...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(100, 2, input_shape=(12,1)))
model.add(Flatten())
