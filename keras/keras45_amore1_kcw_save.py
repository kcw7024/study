...
filepath = './_ModelCheckPoint/amore6/'
...
model.save_weights("./_ModelCheckPoint/amore6_weights/keras46_save_weights1.h5")
...
print('걸린 시간: ', start_time-end_time)
