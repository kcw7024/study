...
parameters = [
    {'randomforestclassifier__n_estimators' : [100, 200], 'randomforestclassifier__max_depth': [40,30,20,50], 'randomforestclassifier__min_samples_leaf':[15, 30, 50, 100]}, #epochs
