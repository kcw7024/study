...
model = XGBClassifier(
    n_estimators=500,
    learning_rate=0.02,
    colsample_bylevel=max(min(0.6533744581056, 1), 0),
    colsample_bytree=max(min(0.8935555548405743, 1), 0),
    max_bin=max(int(round(179.35412914085055)), 100),
    max_depth=int(round(10.454251510664996)),
    min_child_weight=int(round(8.00481013633981)),
    reg_alpha=max(3.495119838012323, 0),
    reg_lambda=max(2.860455343828491, 0),
    subsample=max(min(0.8202733832213396, 1), 0)
)
