...
최적의 매개변수 :  RandomForestRegressor(max_depth=10, min_samples_split=4, n_jobs=-1)
최적의 파라미터 :  {'max_depth': 10, 'min_samples_split': 4, 'n_jobs': -1}
best_score_ :  0.8666552364872974
model.score :  0.8659381321943798
r2 스코어 : 0.8659381321943798
최적 튠 R2 :  0.8659381321943798
걸린시간 :  28.34
'''