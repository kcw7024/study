...
np.save('d:/study_data/_save/_npy/keras49_7_train_x.npy', arr=x_train) # train x값
np.save('d:/study_data/_save/_npy/keras49_7_train_y.npy', arr=y_train) # train y값
np.save('d:/study_data/_save/_npy/keras49_7_test_x.npy', arr=x_test) # test x값
np.save('d:/study_data/_save/_npy/keras49_7_test_y.npy', arr=y_test) # test y값
