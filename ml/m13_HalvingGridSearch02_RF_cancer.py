...
최적의 매개변수 :  RandomForestClassifier(max_depth=6, min_samples_split=4, n_jobs=3)
최적의 파라미터 :  {'max_depth': 6, 'min_samples_split': 4, 'n_jobs': 3}
best_score_ :  0.9665079365079364
