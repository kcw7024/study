...
all_input_list = sorted(glob.glob('C:/study/_data/dacon_growth/train_input/*.csv'))
all_target_list = sorted(glob.glob('C:/study/_data/dacon_growth/train_target/*.csv'))
...
test_input_list = sorted(glob.glob('C:/study/_data/dacon_growth/test_input/*.csv'))
test_target_list = sorted(glob.glob('C:/study/_data/dacon_growth/test_target/*.csv'))
