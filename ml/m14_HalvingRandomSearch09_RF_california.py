...
최적의 매개변수 :  RandomForestRegressor(max_depth=12, min_samples_split=4, n_jobs=-1)
최적의 파라미터 :  {'n_jobs': -1, 'min_samples_split': 4, 'max_depth': 12}
best_score_ :  0.6583064018455472
model.score :  0.8027907097611786
r2 스코어 : 0.8027907097611786
최적 튠 R2 :  0.8027907097611786
걸린시간 :  30.49
