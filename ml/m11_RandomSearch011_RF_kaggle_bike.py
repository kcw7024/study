...
최적의 매개변수 :  RandomForestRegressor(max_depth=10, min_samples_split=4, n_jobs=3)
최적의 파라미터 :  {'n_jobs': 3, 'min_samples_split': 4, 'max_depth': 10}
best_score_ :  0.9295524531372275
model.score :  0.917540135955222
r2 스코어 : 0.917540135955222
최적 튠 R2 :  0.917540135955222
걸린시간 :  14.95
