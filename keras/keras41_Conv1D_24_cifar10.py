...
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, LSTM, Conv1D #이미지작업(Conv2D), 데이터를 펼친다(Flatten)
...
'''
loss :  2.129025936126709
accuracy :  0.2054000049829483

Conv1D
loss :  1.5647413730621338
