...
from sklearn.model_selection import StratifiedKFold, train_test_split, KFold, cross_val_score, cross_val_predict, GridSearchCV
...
# 최적의 파라미터 :  {'max_depth': 12, 'min_samples_split': 5, 'n_jobs': -1}
# best_score_ :  0.8359854111879248
# model.score :  0.9204825958046517
# r2 스코어 : 0.9204825958046517
# 최적 튠 R2 :  0.9204825958046517
# 걸린시간 :  25.4