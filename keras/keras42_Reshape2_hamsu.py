...
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, Conv1D, LSTM, Reshape, SimpleRNN, Input
...
conv2 = Conv2D(filters=64, kernel_size=(3, 3), padding='same')(input)       # (28, 28, 64)
dense1 = Dense(10, activation='relu')(conv2)                                # (28, 28, 10)
#resh1 = Reshape(target_shape=(784, 10))(dense1)                            # (N, 784, 10)
resh1 = Reshape(target_shape=(784*10, ))(dense1)                            # (N, 7840)
flat = Flatten()(resh1)                                                     # (N, 7840) 
dense2 = Dense(10, activation='relu')(flat)                                 # (N, 10)
