...
# shape는 input shape, None은 자동으로 잡아줌
x_train = tf.placeholder(tf.float32, shape=[None])
# shape는 input shape, None은 자동으로 잡아줌
y_train = tf.placeholder(tf.float32, shape=[None])


# []안의 숫자는 1 또는 변수의 갯수와 맞춰줘야 함
...
# 3-3. 훈련
# InteractiveSession 은 with 문 사용못함
...
# [6, 7, 8] 예측 :  [13.001743 15.002213 17.00268 ]
print('[6, 7, 8] 예측 : ',  y_predict.eval(feed_dict={x_test: x_text_data}))
sess.close()
