...
# 최적의 매개변수 :  RandomForestRegressor(max_depth=9, min_samples_leaf=10, n_estimators=200)
# 최적의 파라미터 :  {'n_estimators': 200, 'min_samples_leaf': 10, 'max_depth': 9}
# best_score_ :  0.3988247024049256
# model.score :  0.5717614885890181
# r2 스코어 : 0.5717614885890181
# 최적 튠 R2 :  0.5717614885890181
# 걸린시간 :  4.16