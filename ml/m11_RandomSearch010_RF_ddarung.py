...
'''
최적의 매개변수 :  RandomForestRegressor(max_depth=12, n_jobs=3)
최적의 파라미터 :  {'n_jobs': 3, 'min_samples_split': 2, 'max_depth': 12}
best_score_ :  0.7720003635367894
model.score :  0.7834445941673726
r2 스코어 : 0.7834445941673726
최적 튠 R2 :  0.7834445941673726
걸린시간 :  5.73
