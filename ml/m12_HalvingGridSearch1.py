...
model = HalvingGridSearchCV(SVC(), parameters, cv=kfold, verbose=1, refit=True, n_jobs=-1) # 42 * 5(kfold) = 210
...
factor: 3
----------
iter: 0 (적은 데이터로 전체훈련을 돈다.)
n_candidates: 42
n_resources: 30
Fitting 5 folds for each of 42 candidates, totalling 210 fits
----------
iter: 1 (나온 최적의 파라미터에서 일부를 뽑아 다시 훈련, 데이터량은 증가)
n_candidates: 14
n_resources: 90
