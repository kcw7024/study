...
'''
The total space of parameters 144 is smaller than n_iter=5810. Running 144 iterations. For exhaustive searches, use GridSearchCV
# 매개변수 총공간이 n_iter 보다 작다. 더 정확한 검색을 위해서 GridSearchCV를 권장하는 문구.
...
best_score_ :  0.779283286192378
model.score :  0.886386611261348
r2 스코어 : 0.886386611261348
최적 튠 R2 :  0.886386611261348
걸린시간 :  34.38
'''