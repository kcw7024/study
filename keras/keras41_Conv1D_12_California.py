...
print(x_train.shape) # (16512, 4, 2, 1)
print(np.unique(y_train, return_counts=True))
#(array([0.14999, 0.225  , 0.25   , ..., 4.991  , 5.     , 5.00001]), array([  4,   2,   1, ...,   1,  20, 776], dtype=int64))
...
loss :  0.08310713618993759
r2 score :  0.3008221433588698

Conv1D

loss :  0.07951539754867554
r2 score :  0.329298183939234
