...
# #4. 평가, 예측
# print('XGBRegresor 스코어 : ', model.score(x_test, y_test)) 


'''
XGBRegressor 스코어 :  0.7879670452820673
LinearRegression 스코어 :  0.6032302065388713
KNeighborsRegressor 스코어 :  0.7332422197541133
DecisionTreeRegressor 스코어 :  0.7911827153276905
RandomForestRegressor 스코어 :  0.7773235811983299
