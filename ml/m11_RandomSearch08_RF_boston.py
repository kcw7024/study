...
# 최적의 매개변수 :  RandomForestRegressor(max_depth=10, min_samples_leaf=3, n_estimators=150)
# 최적의 파라미터 :  {'n_estimators': 150, 'min_samples_leaf': 3, 'max_depth': 10}
# best_score_ :  0.8039003715807695
# model.score :  0.9200409551140392
# r2 스코어 : 0.9200409551140392
# 최적 튠 R2 :  0.9200409551140392
# 걸린시간 :  4.74