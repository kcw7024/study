...
#(350, 150, 150, 3) (150, 150, 150, 3) (350, 3) (150, 3)


#수치화한 데이터를 저장한다.
np.save('d:/study_data/_save/_npy/keras47_3_train_x.npy', arr=x_train) # train x값
np.save('d:/study_data/_save/_npy/keras47_3_train_y.npy', arr=y_train) # train y값
np.save('d:/study_data/_save/_npy/keras47_3_test_x.npy', arr=x_test) # test x값
np.save('d:/study_data/_save/_npy/keras47_3_test_y.npy', arr=y_test) # test y값
