...
import numpy as np
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, Dropout, LSTM, Conv1D
...
model.fit(x_train,y_train, validation_split=0.2, callbacks=[earlyStopping],
          epochs=10, batch_size=248, verbose=1)
...
# loss :  0.6454455852508545
# accuracy :  0.7524999976158142
# ============================
# acc score : 1.0

# Conv1D
# loss :  0.3788905441761017
# accuracy :  0.8731666803359985
