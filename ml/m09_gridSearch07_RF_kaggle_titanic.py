...
# 최적의 매개변수 :  RandomForestClassifier(max_depth=6, min_samples_split=4, n_jobs=5)
# 최적의 파라미터 :  {'max_depth': 6, 'min_samples_split': 4, 'n_jobs': 5}   
# best_score_ :  0.8174825174825173
# model.score :  0.8435754189944135
# accuracy_score : 0.8435754189944135
# 최적 튠 ACC :  0.8435754189944135
# 걸린시간 :  26.61
