...
# LogisticRegression 분류모델 LinearRegression 회귀
...
train = train_enc.drop(columns=['TypeofContact', 'NumberOfChildrenVisiting',
                       'NumberOfPersonVisiting', 'OwnCar', 'MonthlyIncome'])
test = test.drop(columns=['TypeofContact', 'NumberOfChildrenVisiting',
                 'NumberOfPersonVisiting', 'OwnCar', 'MonthlyIncome'])
...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, random_state=44, train_size=0.86, shuffle=True)
