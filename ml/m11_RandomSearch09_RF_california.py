...
# 최적의 매개변수 :  RandomForestRegressor(max_depth=12, min_samples_split=20, n_jobs=-1)
# 최적의 파라미터 :  {'n_jobs': -1, 'min_samples_split': 20, 'max_depth': 12}
# best_score_ :  0.78344160049252
# model.score :  0.806772919936817
# r2 스코어 : 0.806772919936817
# 최적 튠 R2 :  0.806772919936817
# 걸린시간 :  56.14